...
SELECT * FROM country WHERE continent LIKE '%Europe' AND population = 1000
...
SELECT * 
FROM city c
LEFT JOIN country b ON b.code = c.countrycode
WHERE b.continent = 'South America' AND  c.name LIKE 'San%'
